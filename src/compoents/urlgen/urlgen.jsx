...
const UrlGen = () => {
  ...
  return (
    ...
    >
      <div className="url-gen-div">
        <h3 style={{ color: "black", textAlign: "left" }}>Supplier Pannel</h3>
        <form onSubmit={handleSubmit(handleRegistration)}>
          ...
          <br /> */}
            ...
            <button
              style={{ width: "400px", background: "black", color: "white" }}
            >
        ...
        {flagForNewUrl && (
          <>
            ...
            <button
              ...
              style={{ width: "400px", background: "red", color: "white" }}
            >
              Reset
            </button>
          </>
